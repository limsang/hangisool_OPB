...
import com.hangisool.lcd_a_h.CameraPreviewActivity;
...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback{
  ...
  public CameraPreview(Context context, AttributeSet attrs) {
    ...
    mCamera = CameraPreviewActivity.getCamera();
    if(mCamera == null){
      mCamera = Camera.open();
    }
  ...
  public void surfaceChanged(SurfaceHolder surfaceHolder, int i, int w, int h) {
    ...
    try {
      ...
      int rotation = CameraPreviewActivity.getInstance.getWindowManager().getDefaultDisplay().getRotation();
